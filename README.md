...
As of now the best method to do this is to take typed notes in markdown or magic markdown - Notion. Then take images of your notes and ask a slave convolutional neural network selotaped onto an llm hidden behind a text box to output markdown.  
The problem is I want the document layout to be preserved, not just the text.

P4p3r is being built to solve this specifically and locally, with no external API dependencies and plug into existing workflows.
